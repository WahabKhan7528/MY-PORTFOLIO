    ...
    <section ref={container} className="relative w-full h-[calc(100vh-var(--nav-height))] mt-[var(--nav-height)] bg-black overflow-hidden flex items-center justify-center px-4 sm:px-6 md:px-12 lg:px-24">
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col items-center text-center">
        <div className="hero-meta flex items-center justify-center gap-4 mb-8">
          ...
          <span className="text-[12px] font-mono tracking-[0.6em] text-white/70 uppercase">/ About \</span>
          <div className="h-px w-12 bg-white/40" />
        </div>

        <h1 className="hero-title text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-display font-black text-white tracking-tighter leading-[0.85] sm:leading-[0.82] uppercase flex flex-col mb-12">
          <span className="inline-block overflow-hidden pb-2">
            <span className="hero-title-line inline-block">The Architect</span>
          </span>
          <span className="inline-block overflow-hidden">
            <span className="hero-title-line inline-block text-white/20 italic">About</span>
          </span>
        </h1>
        ...
        <p className="hero-desc text-xs sm:text-sm md:text-base lg:text-lg text-gray-400 font-light leading-relaxed max-w-2xl mx-auto">
          Full-stack architect who balances performance and design. I build reliable web systems using the MERN stack.
        </p>
      </div>
