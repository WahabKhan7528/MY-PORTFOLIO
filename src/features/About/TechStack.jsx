      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-8">
          <div className="max-w-xl">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-xs font-mono tracking-[0.6em] text-white/70 uppercase">
                STACK_INTEGRITY
              </span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-display font-black text-white tracking-tighter">
              THE ARSENAL.<br />
              <span className="text-white/20 italic uppercase text-2xl sm:text-4xl tracking-wide sm:tracking-widest">Architecture</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stack.map((item, i) => (
            ...
            >
              <div className="text-xs font-mono text-white/70 mb-8 tracking-widest uppercase">
                {item.category}
              </div>
