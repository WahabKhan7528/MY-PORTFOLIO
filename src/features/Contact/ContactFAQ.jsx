...
export default function ContactFAQ() {
  ...
  return (
    <section ref={container} className="py-24 sm:py-32 md:py-48 bg-black px-4 sm:px-6 md:px-12 lg:px-24 overflow-hidden relative">
          ...
          {faqs.map((faq, i) => (
            ...
            >
              ...
              <button
                ...
                className="w-full text-left p-6 sm:p-8 lg:p-10 min-h-[44px] flex justify-between items-center relative z-10"
              >
                <div className="flex flex-col gap-3">
                  ...
                  <span className={`text-lg sm:text-xl md:text-2xl font-mono tracking-wider uppercase break-words transition-colors duration-500 ${activeIndex === i ? 'text-white' : 'text-white/70 group-hover:text-white'}`}>
                    {faq.q}
                  </span>
                </div>
              ...
              >
                <div className="px-6 sm:px-8 lg:px-10 pb-10 sm:pb-14 relative">
