...
export default function ProjectsArchive() {
  ...
  return (
    <section ref={container} className="bg-black py-32 px-6 md:px-24 border-t border-white/5">
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col">
            {logEntries.map((log) => (
              <div 
                key={log.id} 
                className="archive-row grid grid-cols-2 md:grid-cols-4 py-8 border-b border-white/5 hover:bg-white/5 transition-colors group cursor-crosshair"
              >
                ...
                <span className="text-sm font-mono text-white/40 hidden md:block">{log.category}</span>
