...
export default function ProjectsCTA() {
  ...
  return (
    <section ref={container} className="bg-black py-40 md:py-60 px-6 md:px-24 flex items-center justify-center relative overflow-hidden border-t border-white/5">
      {/* Radar Background */}
      <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
        <div className="relative w-[800px] h-[800px] border border-white/20 rounded-full flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10 order-1 lg:order-2 lg:text-right">
            <h2 className="cta-text-reveal text-6xl md:text-8xl font-display font-black tracking-tighter uppercase leading-[0.85]">
              Build<br />
            ...
            <div className="cta-text-reveal flex flex-col lg:items-end gap-8">
              <p className="text-gray-400 font-light text-sm md:text-lg max-w-md lg:ml-auto leading-relaxed text-white/60">
                ...
                <Link 
                to="/contact"
                className="group relative w-full sm:w-fit px-12 py-8 bg-white text-black overflow-hidden transition-all duration-500 hover:scale-[1.02] flex items-center justify-center gap-4"
              >
