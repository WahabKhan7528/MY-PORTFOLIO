  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-20 gap-8 phi-header">
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-xs font-mono tracking-[0.8em] text-white/70 uppercase">
                OPERATIONAL_PHILOSOPHY
              </span>
            </div>
              <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-6xl font-display font-black text-white tracking-tighter leading-none mb-4">
              ARCHITECTURAL <br />
            ...
            >
              ...
              <div className="flex justify-between items-start mb-12">
                ...
                <div className="text-right">
                  <div className="text-[10px] font-mono text-white/50 uppercase tracking-widest mb-1">MODULE_TAG</div>
              ...
              <div className="space-y-3 pt-8 border-t border-white/5">
                {phi.metrics.map((metric, idx) => (
                  <div key={idx} className="flex justify-between items-center group/metric">
                    <span className="text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] font-mono text-white/40 group-hover/metric:text-white/60 transition-colors">
                      {metric.split(':')[0]}
                    </span>
                    <div className="flex-1 mx-4 h-[1px] bg-white/5 group-hover/metric:bg-white/10 transition-colors" />
                    <span className="text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] font-mono text-white/60 group-hover/metric:text-white/90 transition-colors">
                      {metric.split(':')[1]}
                    </span>
                  </div>
                ))}
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap gap-x-12 gap-y-4 justify-between items-center opacity-40 hover:opacity-80 transition-opacity">
          ...
          <div className="flex gap-4 items-center">
            <span className="text-[10px] font-mono uppercase tracking-[0.2em]">SYSTEM_STABILITY</span>
