...
export default function Hero() {
  ...
  return (
    <section
      ref={container}
      className="hero-section home-hero-section relative w-full h-screen overflow-hidden bg-black flex items-center justify-center px-4 sm:px-6 md:px-12 lg:px-24"
    >
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col items-center text-center">
        <div className="hero-meta flex items-center justify-center gap-4 mb-8">
          ...
          <span className="text-[12px] font-mono tracking-[0.6em] text-white/70 uppercase">MERN Stack</span>
          <div className="h-px w-12 bg-white/40" />
        </div>
        ...
        <div className="hero-cta-container flex flex-wrap gap-6 items-center justify-center">
          <Link
            to="/projects"
            className="group relative px-10 py-5 text-sm bg-gray-200 text-black overflow-hidden transition-all duration-300 hover:bg-white hover:scale-105 active:scale-95"
          >
          ...
          <Link
            to="/contact"
            className="px-10 py-5 border border-white/10 text-white text-[11px] tracking-[0.3em] uppercase font-bold bg-white/5 backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-white/30"
          >
            Contact
          </Link>
        </div>
