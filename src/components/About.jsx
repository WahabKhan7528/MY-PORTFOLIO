                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="heading-lg mb-6">
                            Passionate About <span className="text-gradient">Full-Stack Development</span>
                        </h2>

                        <div className="space-y-4 text-gray-300 leading-relaxed">
                            <p>
                                I'm a MERN stack developer specializing in building modern, scalable web applications.
                                With expertise in MongoDB, Express.js, React, and Node.js, I create end-to-end solutions
                                that solve real-world problems.
                            </p>
                            <p>
                                My approach combines clean code practices, responsive design, and performance optimization
                                to deliver applications that not only look great but perform exceptionally. From RESTful APIs
                                to dynamic user interfaces, I handle every aspect of web development.
                            </p>
                            <p>
                                Whether it's building a complex e-commerce platform, a real-time chat application, or a
                                data-driven dashboard, I bring technical expertise and creative problem-solving to every project.
                            </p>
                        </div>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="glass-hover rounded-3xl p-8"
                        >
                            <h3 className="text-xl font-display font-semibold mb-6">Additional Expertise</h3>
