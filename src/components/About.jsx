...
export default function About() {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ...
        { opacity: 0, y: 20 },
        {
          ...
          stagger: 0.07,
          ease: "power2.out",
          scrollTrigger: { trigger: ".about-paragraphs", start: "top 80%" },
        },
      );
      ...
      animateStat(yearsRef, 2, "+");
      animateStat(projectsRef, 3, "+");
  ...
  return (
    <section
      id="about"
      ref={container}
      className="section-padding min-h-screen flex flex-col justify-center py-24 lg:py-32 relative overflow-hidden bg-black text-white"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="flex flex-col justify-center">
            <div className="mb-12 overflow-hidden">
              <div className="text-[10px] tracking-[0.3em] uppercase text-gray-500 mb-4 font-bold about-title-inner">
                The Architect
              </div>
            ...
            <div className="about-paragraphs space-y-8 text-gray-400 md:text-xl font-light leading-relaxed max-w-lg">
              <p className="about-paragraph text-white text-2xl md:text-3xl font-normal leading-snug">
                I bridge the gap between complex design and functional,
                high-performance interfaces.
              </p>
              <p className="about-paragraph">
                I'm a MERN stack developer specializing in building modern,
                immersive web applications. With deep expertise in React,
                Node.js, Express, MongoDB, and GSAP, I build applications that
                not only look great but perform exceptionally.
              </p>
              <p className="about-paragraph">
                My approach combines clean code practices, responsive design,
                and rigorous performance optimization across the stack to
          ...
          <div className="flex flex-col justify-center lg:pl-16">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-16">
              <div className="border-t border-white/20 pt-8">
                <div
                  ref={yearsRef}
                  className="text-7xl md:text-[100px] font-display font-black text-white leading-none mb-4 tracking-tighter"
                >
                  0+
                </div>
