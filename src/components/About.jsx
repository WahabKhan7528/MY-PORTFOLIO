      ...
      <div className="max-w-7xl mx-auto w-full px-6 sm:px-8 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-20 items-start">
          ...
          <div className="lg:w-1/2 space-y-16">
            <div className="space-y-6 info-stagger">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] font-mono tracking-[0.6em] text-white/50 uppercase">About</span>
              </div>
            ...
            <div className="space-y-10 info-stagger">
              <div className="relative border-l border-white/20 pl-10">
                ...
                <div className="bg-white/[0.02] border border-white/5 p-8 font-mono text-sm leading-relaxed text-gray-400 relative overflow-hidden group">
                ...
                <div className="text-[10px] text-white/20 mb-4 uppercase tracking-widest">// BIO_TERMINAL</div>
                <p>
                  I focus on full-stack solutions using the MERN stack. My work aims for clear, scalable, and reliable code.
                </p>
                <div className="mt-6 flex gap-4 text-[10px] text-white/30">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 info-stagger pt-4">
              <div className="group relative">
                ...
                <div className="text-[9px] sm:text-[10px] font-mono text-white/40 uppercase tracking-[0.3em]">Years Experience</div>
              ...
              <div className="group relative">
                ...
                <div className="text-[9px] sm:text-[10px] font-mono text-white/40 uppercase tracking-[0.3em]">Systems Built</div>
                <div className="absolute -left-4 top-0 w-0.5 h-full bg-white/10 group-hover:bg-white/40 transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative group">
            ...
            <div className="relative z-10 border border-white/10 p-5 bg-white/5 backdrop-blur-sm transition-all duration-700 group-hover:border-white/30">
              <div className="overflow-hidden relative">
                <img
                  ...
                  alt="The Architect"
                  className="parallax-img w-full object-cover grayscale contrast-125 brightness-75 scale-125 transition-all duration-700 group-hover:scale-100 group-hover:brightness-100 group-hover:grayscale-0 group-hover:contrast-100"
                />
              ...
              {/* Technical Elements */}
              <div className="absolute -top-6 -right-6 w-32 h-32 border-t-2 border-r-2 border-white/20 pointer-events-none transition-all duration-500 group-hover:-top-2 group-hover:-right-2 group-hover:border-white/50" />
              <div className="absolute -bottom-6 -left-6 w-32 h-32 border-b-2 border-l-2 border-white/20 pointer-events-none transition-all duration-500 group-hover:-bottom-2 group-hover:-left-2 group-hover:border-white/50" />

              <div className="mt-8 flex justify-between items-center">
                <div className="flex flex-col gap-1">
                  <div className="text-[10px] font-mono text-white/50 uppercase tracking-[0.4em]">AUTH_PROTOCOL: ARCHITECT</div>
                  <div className="text-[8px] font-mono text-white/20 uppercase tracking-[0.2em]">REF_ID: 882-X04</div>
                </div>
            ...
            <div className="absolute -top-10 -left-10 w-40 h-40 border border-white/5 bg-white/[0.01] -z-10 animate-pulse" />
            <div className="absolute -bottom-10 -right-10 w-64 h-64 border border-white/5 bg-white/[0.01] -z-10 rotate-12 transition-transform duration-1000 group-hover:rotate-45" />
          </div>
        </div>
      </div>
    </section>
